...
- **NSFW-фильтр**: изображения автоматически классифицируются как 18+ или нет; по умолчанию NSFW-контент скрыт, включается вручную через `nsfw_enabled` в таблице `users`
